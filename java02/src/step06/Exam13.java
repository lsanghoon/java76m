 ...
 * - auto-boxing: 원시타입(primitive type) --> 랩퍼객체, 랩퍼객체 ---> 원시타입 자동변
 */
...
public class Exam13 {
	...
	public static void main(String[] args) throws Exception {
		...
		//1) unboxing: 랩퍼 클래스 ---> 원시타입
		int i2 = obj;	// 내부적으로 obj.intValue()를 자동 호출한다. 다음 코드와 같다.
		//int i2 = obj.intValue();
		System.out.println(i2);
		// 이렇게 인스턴스 안에 들어있던 값을 꺼내서 i2변수에 담는다고 해서 
		// "unboxing" 이라고 부른다.
		
		//2) boxing: 원시타입 ---> 래퍼 클래스
		...
		// 오토박싱(auto-boxing)?
		// 원시타입과 래퍼 클래스 사이에 자동으로 boxing/unboxing이 일어난다.
