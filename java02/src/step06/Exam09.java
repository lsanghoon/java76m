...
public class Exam09 {
	...
	public static void main(String[] args) {
		...
		//인스턴스가 다름에도 불구하고 equals()는 true를 리턴했다. 이유는?
		// => 상속받은 equals()를 overriding했기 때문이다.
		...
		// StringBuffer는 상속 받은 toString을 overriding하지 않았다.
		// 그래서 리턴 값이 false이다.
		if ((sb1).equals(sb2)) 
