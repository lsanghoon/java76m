...
//상속받은 메서드를 재정의 할수있습니다.
//애노테이션을 사용해서 재정의한 문법을 검사할수 있다.
public class Exam08 {
	static class Student {
		...
		//Object로부터 상속 받은 toString()을 재정의 한다. => Overriding 한다.
		...
		//오버라이딩을 한것이 아니라 toSting() 이라는 메서드를 추가한 것이 되는 경우가 있다.
		//이런 오류는 문법 오류가 아니기 때문에 컴파일러에서 잡아 낼 수 없다.
		//이런 오류를 방지하기 위한 방법 => 애노테이션(annotation)
		//애노테이션이란?
		// => 컴파일러나 JVM에게 전달하는 아주 특별한 주석, 명령, 정보를 말한다.
		@Override	// 자바 컴파일러에게 오버라이드 검사를 요청하는 주석이다.
		//public String toSting() {	//메서드명이 잘못되면 컴파일러가 오류를 뛰운다.
