/*
 * 주제 : 다형성 - 다형적 변수의 활용
 * - 상위 클래스의 레퍼런스를 이용하여하위 클래스를 가리키기
...
public class Test1 {
	...
	public static void main(String[] args) {
		...
		float f = 3.14f;
		boolean b = true;
		String s = "Hello";	// new String("Hello") // 상수로 선언하면 반복 생성하지않는다
		Student s1 = new Student("홍길동", "111-1111");
		Product p = new Product("아이폰", 980000);
		
		//int, float, boolean과 원시타입의 데이터인 경우,
		// 원시타입과 대응하는 랩퍼 클래스의 인스턴스를 생성하여 print()로 넘긴다. => auto-boxing
	...
	static void print(Object obj) {
		 ...
		 * 	 "다형적 변수(polymorphic variable)"라고 한다.
		 */
