...
public class Test01 {
	...
	static class Account {
		...
		// => 여러스레드가 동시에 접근했을 때 문제가 발생할 수 있는 코드
		// => 해결책? 한번에 한 스레드만 접근하도록 제약을 가한다.
		//				   "뮤텍스(Mutex)" 라 부른다.
		...
		private void delay() {
			...
			// 1) 8바이트크기의 데이터를 다루는 것이 4바이트를 다루는 것 보다 느리다.(32bit운영체제의경우)
			//		자바는 기본이 4바이트다.
