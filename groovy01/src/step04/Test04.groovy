...
println plus(10)	// 값을 한 개 넘기면 it변수에는 10이라는 값이 들어간다.
//println plus(10, 20)	// 오류!! 두 개의 값을 넘기면 it변수를 사용할 수 없다.
println plus()	// 값을 넘기지 않으면 it 변수에 null을 의미하는 NullObject가 들어간다.bcw

/* "it" 변수의 용도?
 * 1) 값을 한 개만 넣을 때 사용
 * 2) 임의의 값 여러 개를 받는 파라미터를 선언할 때 사용. "..." 파라미터. 
 */
