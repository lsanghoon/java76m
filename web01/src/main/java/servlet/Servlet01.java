 ...
 * init(), service(), destroy() 삼인방 =>
   ...
   getServletInfo() - 웹 애플리케이션 관리 화면에서 서블릿의 정보를 출력할 때 호출한다.
   										서블릿의 정보를 간단한 문자열로 표현하여 리턴한다.
   										개발자가 직접 이 메서드를 호출할 일이 드물다.

   getServletConfig() - 개발자가 ServlertConfig객체를 얻고자 할 때 가끔 호출한다.
...
public class Servlet01 implements Servlet {
	...
	public String getServletInfo() {
		System.out.println("getServeltInfo()");
		return "Servlet01";
	}
