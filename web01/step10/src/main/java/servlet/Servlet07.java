...
public class Servlet07 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) 
		...
		// 유효기간이 지난 쿠키는 자동 삭제한다.	=> 쿠키를 보내려는 시점에서 유효기간을 검사한다.
		...
		// 브라우저를 모두 닫으면 내부 메모리도 헤제되기 때문에, 쿠키 정보도 제거된다.
...
Set-Cookie: name=hong; Path=/web01		<-- 쿠키의 사용 범위가 정해져있지 않다
Set-Cookie: age=20										<-- 쿠키의 사용 범위가 정해져 있다.
Content-Type: text/plain;charset=UTF-8
Content-Length: 27
Date: Mon, 30 Nov 2015 08:05:49 GMT
